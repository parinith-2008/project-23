...
function setup() {
	...
	leftbox = Bodies.rectangle(boxPosition+20, boxY, 20,100 , {isStatic:true} );
	 World.add(world, leftbox);
	 
	 rightbox = createSprite(boxPosition+200,boxY,20,100)
	 rightbox.shapeColor=("red")
	 rightbox = Bodies.rectangle(boxPosition+200-20,boxY, 20,100 , {isStatic:true} );
	 World.add(world, rightbox);

	 bottombox = createSprite(boxPosition+100,boxY+40,200,20)
